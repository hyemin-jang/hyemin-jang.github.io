...
![](C:\development\githubpage\my-blog\content\assets\posting images\jpa.PNG)
...
![](C:\development\githubpage\my-blog\content\assets\posting images\dialect.PNG)
...
1. JPA 프로젝트로 변환
   ...
   : 프로젝트 우클릭 - Configure - Convert to JPA Project - Next - Next - **Disable Library Configuration**을 설정해 줄 것이다(메이븐 사용할 것임)

   ![](C:\development\githubpage\my-blog\content\assets\posting images\jpa project.PNG)



​	아래와 같이 `persistence.xml`파일이 생겼으면 정상적으로 변환 완료

![](C:\development\githubpage\my-blog\content\assets\posting images\persistence.PNG)
...
![](C:\development\githubpage\my-blog\content\assets\posting images\table.png)
...
| EntityManagerFactory | 여러 EntityManager 인스턴스를 작성하고 관리                  |
| EntityManager        | 객체의 지속성 작업을 관리. CRUD 수행.                        |
